<li><!--<a href="index.html"><i class="l-basic-laptop"></i><span class="txt">Dashboard</span></a>-->
    ...
    <a href="#"><i class="fa fa-user fa-1x"></i> <span class="txt">Usuários</span></a>
    <ul class="sub">
        <li><a href="<?php echo base_url() ?>listarUsuarios"><span class="txt">Listar</span></a>
        </li>
        <li><a href="<?php echo base_url() ?>adicionarUsuarios"><span class="txt">Criar</span></a>
        </li>
    </ul>
</li>
<li>
    <a href="#"><i class="l-arrows-square-check"></i><span class="txt">Preventivas</span></a>
    <ul class="sub">
        <li><a href="<?php echo base_url() ?>Preventiva"><span class="txt">Listar</span></a>
        </li>
        <li><a href="acompanhamento"><span class="txt">Acompanhamento</span></a>
        </li>
        <li><a href="atualizarStatusPreventiva"><span class="txt">Atualizar Status</span></a>
        </li>
        <li><a href="CadastrarPreventiva"><span class="txt">Cadastrar Preventivas</span></a>
        </li>
    </ul>
</li>
<li>
    <a href="#"><i class="l-basic-webpage"></i><span class="txt">Estações</span></a>
    <ul class="sub">
        <!--<li>-->
<!--            <a href="#"><span class="txt">Estações</span></a>
            <ul class="sub">-->
                <li><a href="estacoes"><span class="txt">Listar</span></a>
                </li>
                <!--<li><a href="404.html"><span class="txt">Adicionar</span></a>-->
                <!--</li>-->
            <!--</ul>-->
        <!--</li>-->
    </ul>
